...
## Current Task 
 - [prioritet] Настроить переподключение при анонимном чтении:
 - Удалить всю логику переподключения из Connection
 - Создать метод получения контекстов из сокетов.
 - В клиенте - Полчаем контексты. Разрушаем Connection. Создаем новый. Запускаем цикл подключения.
---
