...
Пока что всё довольно просто — иногда даже работает. сть фильтры по ролям (можно принимать запросы только от сабов, випов или вообще всех), белые и чёрные списки
...
Перед установкой система проверяет, есть ли карта уже в папке — если да, то не качает повторно. Потом можно будет это отключить.
