...
Быстрый старт - скачай -> разархивируй -> запусти RequestFlow.exe -> проверь путь (прочитаешь вывод консоли) -> жмешь Enter -> выбираешь папку с картами osu! и подключаеься к своему твич каналу. Готово!
