[Общая архитектура модулей системы](ORF_desing.png)
...
## Current Task
 - [PRIORITET] фикс парсинга сообщений - все логи готовы. Пол беды ясно, ' ' пробелы в начале, которые парсер должен отсекать остаются. Добавить БАЗОВУЮ обработку CAP ответов и STATUSCODE сообщений. 
