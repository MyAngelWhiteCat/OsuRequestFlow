...
[Приоритетно] Понять насколько сильно повлияли измения связанные с попыткой внедрения классов-друзей для тестирования
[Отложено]Рефакторинг последнего огромного коммита. Анализ багов, создать побольше тесткейсов.
