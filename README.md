...
Исправить определитель типов сообщений. Сделать его более читаемым. Оценка тех долга
...
### IRC Client
- Исправить определитель типов сообщений. Сделать его более читаемым. Вынести реализацию классов-визиторов в irc.cpp. Оценка тех долга
- (факап)Внесение архитектурных изменений -> Переход на ассинхронные операции.
- Проверка соединения.
- Тестирование.
