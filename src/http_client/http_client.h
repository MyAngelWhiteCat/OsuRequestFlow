...
#include "http_client/request_builder.h"
#include "http_client/response_parser.h"
#include "http_client/connection_pool.h"
...
namespace http_domain {
    ...
    public:
        ...
        void SetMaxFileSize(size_t file_size_MiB) {
